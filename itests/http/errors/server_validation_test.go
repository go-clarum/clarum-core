...
func TestMissingTextRequestPayloadValidation(t *testing.T) {
	expectedError := "HTTP server errorsServer: validation error - payload missing - expected [expected payload] but received no payload"
...
func TestWrongTextRequestPayloadValidation(t *testing.T) {
	expectedError := "HTTP server errorsServer: validation error - payload mismatch - expected [expected payload] but received [wrong payload]"
